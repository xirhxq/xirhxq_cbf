...
VectorXd Energy_CBF::dhdx(VectorXd _x) {
    VectorXd res = _x;
...
VectorXd Energy_CBF::constraint_u_coe(VectorXd& _f, MatrixXd& _g, VectorXd& _x) {
    return dhdx(_x).transpose() * _g;
}

double Energy_CBF::constraint_const(VectorXd & _f, MatrixXd & _g, VectorXd & _x) {
